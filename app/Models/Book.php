...
class Book extends Model
{
    ...
    {
        // defining 1 to many which means 1 book can have many reviews
    ...
    // sort the books by the amount of reviews
    public function scopePopular(Builder $query, $from = null, $to = null): Builder|QueryBuilder
    {
        return $query->withReviewsCount()->orderBy('reviews_count', 'desc');
    }

    // sort the books by the average reviews ratings
    ...
    public function scopeMinReviews(Builder $query, int $minReviews): Builder|QueryBuilder
    {
        ...
        // return $query->where('reviews_count', '>=', $minReviews); // for laravel 11
    }
